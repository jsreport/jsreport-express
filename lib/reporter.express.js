...
var startExpressApp = function (reporter, app, config) {
  ...
  if (config.certificate.cert && fs.existsSync(reporter.options.rootDirectory, config.certificate.cert)) {
  ...
  if (config.certificate.pfx) {
    if (fs.existsSync(reporter.options.rootDirectory, config.certificate.pfx)) {
